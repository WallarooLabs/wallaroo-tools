...
primitive Bytes
  ...
  fun from_u32(u32: U32, arr: Array[U8] = Array[U8](4)): Array[U8] =>
  ...
  fun from_u64(u64: U64, arr: Array[U8] = Array[U8](8)): Array[U8] =>
  ...
  fun from_f32(f32: F32, arr: Array[U8] = recover Array[U8](4) end):
    Array[U8]
  =>
    from_u32(f32.bits(), consume arr)

  fun from_f64(f64: F64, arr: Array[U8] = recover Array[U8](8) end):
    Array[U8]
  =>
